...
RUN_DIR="${RUN_DIR:-$SCRIPT_DIR/seed_sweeps/tgl_jodie_${DATASET,,}_2gpu_${STAMP}}"
mkdir -p "$RUN_DIR"
...
for seed in "${SEEDS[@]}"; do
  ...
  echo "[TGL JODIE 2GPU] seed=${seed} final_test_ap=${test_ap}"
done
