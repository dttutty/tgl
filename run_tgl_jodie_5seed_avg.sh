...
RUN_DIR="${RUN_DIR:-$SCRIPT_DIR/seed_sweeps/tgl_jodie_${DATASET,,}_${STAMP}}"
mkdir -p "$RUN_DIR"
...
echo "Running TGL JODIE seed sweep on GPU ${GPU_ID}"
...
for seed in "${SEEDS[@]}"; do
  ...
  echo "[TGL JODIE] seed=${seed} final_test_ap=${test_ap}"
done
